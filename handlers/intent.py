...
_HOURS_KEYWORDS = [
    "營業時間", "幾點開", "幾點關", "幾點到幾點", "開門",
    "休息", "假日", "上班時間", "幾時開",
    "幾點營業", "營業到", "幾點到", "上班嗎", "有開嗎",
    "今天有開", "幾點上班", "幾點下班", "幾時營業",
    # 補充常見問法
    "開到幾點", "到幾點", "幾點收", "幾點打烊",
    "今天開", "今天營業", "今天有沒有開", "今天上班",
    "幾點可以", "幾點有人", "有開嗎", "有上班嗎",
    "公休", "週一", "禮拜一", "幾號公休",
    # 「今天有營業嗎」「你們有在營業嗎」等變體
    "今天有營業", "有在營業", "有營業嗎", "有開門嗎", "有在開",
    "有在上班", "今天有上班", "你們有開", "你們有營業",
    # 保護「還有/有沒有」不被誤判為庫存
    "還有開", "還有上班", "還有營業", "有沒有開", "有沒有上班", "有沒有營業",
    # 否定問法：「今天沒開嗎」「沒開嗎」「沒上班嗎」
    "沒開嗎", "今天沒開", "沒在開", "沒上班嗎", "沒有開嗎", "沒有開",
]
